            ...
            <a class="navbar-brand" href="index.html">PrograMeet</a>
                <div class="collapse navbar-collapse" id="navcol-1">
                    <ul class="nav navbar-nav">
                        ...
                        <li class="nav-item"><a class="nav-link active" href="/settings.html"><img class="side-link-icons profile w-inline-block" id="myimg" style=" width:30px"></a></li>
                        <li class="nav-item"><a class="nav-link active" href="/chat.html"><img src="https://external-content.duckduckgo.com/iu/?u=https%3A%2F%2Fwww.searchpng.com%2Fwp-content%2Fuploads%2F2019%2F02%2FChat-Icon-PNG.png&f=1&nofb=1" style=" width:25px" id="chat"><a class="nav-link active" ></a></li>
